...
import RNAzureCommunicationUICalling from "../../components/RNAzureCommunicationUICalling";
...
export default function TabCallScreen() {
    ...
    const setLocalAvatar = (avatar: string) => {
    ...
    const setRemoteAvatar = (avatar: string) => {
    ...
    const getsupportedLocales = async () => {
        try {
            ...
            Alert.alert("Error", (e as any).message, [{ text: "Dismiss" }]);
        }
    };
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "#F8F8F8" }}>
            <ScrollView contentInsetAdjustmentBehavior="automatic">
                ...
                <View style={styles.inputContainer}>
                    <Image style={styles.icon} source={require("../../images/cat.png")} />
